 ...
 * @version 11/29/2017
 * PMR: basically had no problem with it since I've already been playing with functions (or methods in Java) for long.
 * although I still have to learn about the meaning of "public" and "static" in Java. Because in C you just declare the return type.
 * Also, can I only declare the name of a function in the beginning and write the function code block after the main function? Some people favor that style in C.
 */
...
//Purpose of program
    ...
    public static void main(String[ ] args)
    {
        ...
        double bytes = 1024;
        double bits = convertBytesToBits(bytes);
        System.out.printf("%8.1f B   = %7.1f b. %n", bytes, bits);
        
        bits = 480;
        bytes = convertBitsToBytes(bits);
        System.out.printf("%8.1f b   = %7.1f B. %n", bits, bytes);
    }//end of main method
}//end of class
