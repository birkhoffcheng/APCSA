...
public class Magpie4
{
	...
	private String transformIYouStatement(String statement)
	{
		...
		int positionOfI = findKeyword (statement, "I");
		if ( positionOfI < 0 )
		{
			positionOfI = findKeyword (statement, "i");
		}
		int positionOfYou = findKeyword (statement, "you", positionOfI + 1);

		String restOfStatement = statement.substring(positionOfI + 1, positionOfYou).trim();
	 ...
	 *
	 * For Activity 5, finish converting this method to use
	 * the array to organize the possible responses. Remove
	 * the if-else-if block. Adjust the code so that a random
	 * response from the array is returned when this method is
	 * called.
	 */
...
/*
PMR: The source code given in the course is not always formmatted with tabs.
Sometimes it is formmatted with four spaces.
Today I found out a way to automatically convert every group of four spaces into a tab in Vim.
I just use these three commands:
:set ts=4
:set noet
:%retab!
It is so cool!
And the style of programming I learned today is also cool.
*/
