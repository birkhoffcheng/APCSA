...
public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		else if ( statement.replaceAll(" ", "").length() == 0 )
		{
				...
				|| findKeyword(statement, "hi") >= 0)
		{
			response = "Hey! How are you doing?";
				...
				|| findKeyword(statement, "studi") >= 0)
		{
			response = "I like to study. Studying makes me happy.";
		}
		else if (findKeyword(statement, "java") >= 0
				|| findKeyword(statement, "Java") >= 0)
		{
			response = "Do you want to talk about Java? I'm programmed in Java.";
		}
		else
		{
